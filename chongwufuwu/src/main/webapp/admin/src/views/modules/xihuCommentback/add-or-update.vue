    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="评价内容" prop="xihuCommentbackText">
                        <el-input type="textarea"  :readonly="ro.xihuCommentbackText" v-model="ruleForm.xihuCommentbackText" placeholder="评价内容"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.xihuCommentbackText" label="评价内容" prop="xihuCommentbackText">
                            <span v-html="ruleForm.xihuCommentbackText"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            //当前text不能修改
            this.ro.xihuCommentbackText = true;
            if (this.role != "管理员"){
            }
        ...
        methods: {
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='xihuCommentbackText'){
                          this.ruleForm.xihuCommentbackText = obj[o];
                          this.ro.xihuCommentbackText = true;
                          continue;
                      }
                      if(o=='replyText'){
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`xihuCommentback/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.xihuCommentbackCrossAddOrUpdateFlag = false;
                                        this.parent.search();
