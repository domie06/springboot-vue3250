        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="昵称" prop="yonghuName">
                       <el-input v-model="ruleForm.yonghuName"
                                 placeholder="昵称" clearable  :readonly="ro.yonghuName"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="会员等级" prop="huiyuandengjiTypes">
                        <el-select v-model="ruleForm.huiyuandengjiTypes" placeholder="请选择会员等级">
                            <el-option
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='huiyuandengjiTypes'){
                          this.ruleForm.huiyuandengjiTypes = obj[o];
                          this.ro.huiyuandengjiTypes = true;
                          continue;
                      }
                      if(o=='yonghuSumJifen'){
                          this.ruleForm.yonghuSumJifen = obj[o];
                          this.ro.yonghuSumJifen = true;
                          continue;
                      }
                      if(o=='yonghuNewJifen'){
                          this.ruleForm.yonghuNewJifen = obj[o];
                          this.ro.yonghuNewJifen = true;
                          continue;
                      }
                    }
