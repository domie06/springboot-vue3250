        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item class="upload" v-if="type!='info' && !ro.shangpinVideo" label="商品视频" prop="shangpinVideo">
                        <file-upload
                            tip="点击上传商品视频"
                            action="file/upload"
                            :limit="3"
                            :multiple="true"
                            :fileUrls="ruleForm.shangpinVideo?ruleForm.shangpinVideo:''"
                            @change="shangpinVideoUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.shangpinVideo" label="商品视频" prop="shangpinVideo">
                            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.shangpinVideo.split(',')" :src="item" width="100" height="100">
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   ...
                   shangpinVideo: [
                              { required: true, message: '商品视频不能为空', trigger: 'blur' },
                          ],
                   shangpinTypes: [
        ...
        methods: {
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='shangpinVideo'){
                          this.ruleForm.shangpinVideo = obj[o];
                          this.ro.shangpinVideo = true;
                          continue;
                      }
                      if(o=='shangpinTypes'){
                      ...
                      if(o=='shangpinPrice'){
                          this.ruleForm.shangpinPrice = obj[o];
                          this.ro.shangpinPrice = true;
                          continue;
                      }
                      ...
                      if(o=='shangpinClicknum'){
                          this.ruleForm.shangpinClicknum = obj[o];
                          this.ro.shangpinClicknum = true;
                          continue;
                      }
                      if(o=='shangxiaTypes'){
            ...
            shangpinVideoUploadChange(fileUrls){
                this.ruleForm.shangpinVideo = fileUrls;
                this.addEditUploadStyleChange()
            },
