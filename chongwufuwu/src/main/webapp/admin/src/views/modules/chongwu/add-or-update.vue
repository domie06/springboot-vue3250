               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="宠物唯一编号" prop="chongwuUuidNumber">
                       <el-input v-model="ruleForm.chongwuUuidNumber"
                                 placeholder="宠物唯一编号" clearable  :readonly="ro.chongwuUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="宠物类型" prop="chongwuTypes">
                        <el-select v-model="ruleForm.chongwuTypes" placeholder="请选择宠物类型">
                            <el-option
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="是否被领养" prop="chongwuLingyangTypes">
                        <el-select v-model="ruleForm.chongwuLingyangTypes" placeholder="请选择是否被领养">
                            <el-option
                                v-for="(item,index) in chongwuLingyangTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
    ...
    export default {
        data() {
            return {
                ...
                ruleForm: {
                    ...
                    chongwuVideo: '',
                    chongwuTypes: '',
                    chongwuLingyangTypes: '',
                    chongwuDelete: '',
                    chongwuContent: '',
                },
                chongwuTypesOptions : [],
                chongwuLingyangTypesOptions : [],
                rules: {
                   chongwuUuidNumber: [
                              { required: true, message: '宠物唯一编号不能为空', trigger: 'blur' },
                          ],
                   chongwuName: [
                   ...
                   chongwuLingyangTypes: [
                              { required: true, message: '是否被领养不能为空', trigger: 'blur' },
                          ],
                   chongwuDelete: [
        ...
        created() {
            ...
            //获取下拉框信息
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=chongwu_lingyang_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.chongwuLingyangTypesOptions = data.data.list;
                    }
                });
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='chongwuUuidNumber'){
                          this.ruleForm.chongwuUuidNumber = obj[o];
                          this.ro.chongwuUuidNumber = true;
                          continue;
                      }
                      if(o=='chongwuName'){
                          this.ruleForm.chongwuName = obj[o];
                          this.ro.chongwuName = true;
                          continue;
                      }
                      if(o=='chongwuPhoto'){
                          this.ruleForm.chongwuPhoto = obj[o];
                          this.ro.chongwuPhoto = true;
                          continue;
                      }
                      if(o=='chongwuVideo'){
                          this.ruleForm.chongwuVideo = obj[o];
                          this.ro.chongwuVideo = true;
                          continue;
                      }
                      if(o=='chongwuTypes'){
                          this.ruleForm.chongwuTypes = obj[o];
                          this.ro.chongwuTypes = true;
                          continue;
                      }
                      if(o=='chongwuLingyangTypes'){
                          this.ruleForm.chongwuLingyangTypes = obj[o];
                          this.ro.chongwuLingyangTypes = true;
                          continue;
                      }
                      if(o=='chongwuDelete'){
                          this.ruleForm.chongwuDelete = obj[o];
                          this.ro.chongwuDelete = true;
                          continue;
                      }
                      if(o=='chongwuContent'){
                          this.ruleForm.chongwuContent = obj[o];
                          this.ro.chongwuContent = true;
                          continue;
                      }
                    }
                }
